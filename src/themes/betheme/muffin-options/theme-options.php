	...
	function mfn_opts_setup(){
		...
		$menu = array(
			...
			'colors' => array(
				...
				'sections' => array( 'colors-general', 'colors-header', 'colors-menu', 'colors-action', 'content', 'colors-footer', 'colors-sliding-top', 'headings', 'colors-shortcodes', 'colors-alerts', 'colors-forms' ),
			),
			...
			'translate' => array(
				...
				'sections'	=> array( 'translate-general', 'translate-blog',  'translate-search', 'translate-404', 'translate-wpml' ),
			),
		...
		$sections['performance-general'] = array(
			...
			'fields' => array(
				...
				array(
					'title' => __('Page loading', 'mfn-opts'),
					'join' => true,
				),
