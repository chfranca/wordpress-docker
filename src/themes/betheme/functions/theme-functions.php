	...
	function mfn_ID( $param = false )
	{
		...
		if (function_exists('is_woocommerce') && is_woocommerce() ) {
			...
			if( is_product() ){
				...
				if( !empty(get_post_meta( get_the_ID(), 'mfn_single_product_template', true )) && get_post_status( get_post_meta( get_the_ID(), 'mfn_single_product_template', true ) ) == 'publish' && get_post_type( get_post_meta( get_the_ID(), 'mfn_single_product_template', true ) ) == 'template'){
					return get_post_meta( get_the_ID(), 'mfn_single_product_template', true );
				}

				if( !empty(get_post_meta(get_the_ID(), 'mfn_product_cat_template')) && get_post_status( get_post_meta( get_the_ID(), 'mfn_product_cat_template', true ) ) == 'publish' && get_post_type( get_post_meta( get_the_ID(), 'mfn_product_cat_template', true ) ) == 'template' ){
					return get_post_meta(get_the_ID(), 'mfn_product_cat_template', true);
				}

				if( !empty(get_post_meta(get_the_ID(), 'mfn_product_tag_template')) && get_post_status( get_post_meta( get_the_ID(), 'mfn_product_tag_template', true ) ) == 'publish' && get_post_type( get_post_meta( get_the_ID(), 'mfn_product_tag_template', true ) ) == 'template' ) {
					return get_post_meta(get_the_ID(), 'mfn_product_tag_template', true);
				}

				if( get_post_meta(get_the_ID(), 'mfn_product_template') && get_post_status( get_post_meta( get_the_ID(), 'mfn_product_template', true ) ) == 'publish' && get_post_type( get_post_meta( get_the_ID(), 'mfn_product_template', true ) ) == 'template' ){
					return get_post_meta(get_the_ID(), 'mfn_product_template', true);
				}

				if( mfn_opts_get('shop-product-template') && get_post_status( mfn_opts_get('shop-product-template') ) == 'publish' && get_post_type( mfn_opts_get('shop-product-template') ) == 'template' ){
				...
				if( (is_product_category() || is_product_tag()) && isset($qo->term_id) && !empty(get_term_meta($qo->term_id, 'mfn_shop_template', true)) && get_post_status( get_term_meta($qo->term_id, 'mfn_shop_template', true) ) == 'publish' && get_post_type( get_term_meta($qo->term_id, 'mfn_shop_template', true) ) == 'template' ){

					return get_term_meta($qo->term_id, 'mfn_shop_template', true);
				}

				if( !empty(get_post_meta(wc_get_page_id('shop'), 'mfn_shop_template')) && get_post_status( get_post_meta(wc_get_page_id('shop'), 'mfn_shop_template', true) ) == 'publish' && get_post_type( get_post_meta(wc_get_page_id('shop'), 'mfn_shop_template', true) ) == 'template' ){

					return get_post_meta(wc_get_page_id('shop'), 'mfn_shop_template', true);
				}

				if( !empty(mfn_opts_get('shop-template')) && get_post_status( mfn_opts_get('shop-template') ) == 'publish' && get_post_type( mfn_opts_get('shop-template') ) == 'template' ){
...
add_editor_style(array('css/editor-style.css','https://fonts.googleapis.com/css?family=Poppins'));
